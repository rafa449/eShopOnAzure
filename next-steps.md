...
- Azure Container App to host the 'basket-api' service.
- Azure Container App to host the 'catalog-api' service.
- Azure Container App to host the 'mobile-bff-shopping' service.
- Azure Container App to host the 'order-processor' service.
- Azure Container App to host the 'ordering-api' service.
- Azure Container App to host the 'payment-processor' service.
- Azure Container App to host the 'web-app' service.
- Azure Container App to host the 'webhook-client' service.
- Azure Container App to host the 'webhooks-api' service.
- Azure Container App to host the 'eshop-apphost' service.
